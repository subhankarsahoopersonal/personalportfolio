    ...
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-slate-950 text-white selection:bg-cyan-500/30 font-sans p-6 md:p-12">
      ...
      <div className="z-10 flex flex-col-reverse lg:flex-row items-center justify-between w-full max-w-6xl mx-auto gap-12 lg:gap-20">
        ...
        <div className="flex flex-col items-center lg:items-start text-center lg:text-left w-full lg:w-1/2">
          ...
          <h2 className="text-xl md:text-2xl font-medium text-slate-300 mb-10 max-w-lg">
            Crafting the next generation of AI & ML web experiences.
          </h2>

          {/* === NEW: RECRUITER DOCK & BOOT BUTTON ROW === */}
          <div className="flex flex-col sm:flex-row items-center gap-6 mb-8 w-full justify-center lg:justify-start">
            ...
            <div className="flex items-center gap-4 px-6 py-3.5 bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl shadow-xl">
              ...
              <a href="https://www.linkedin.com/in/subhankarsahoopersonal" className="text-slate-400 hover:text-cyan-400 transition-all hover:scale-110 hover:drop-shadow-[0_0_10px_rgba(6,182,212,0.8)]" title="LinkedIn">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path fillRule="evenodd" d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" clipRule="evenodd" />
                </svg>
              </a>
              <a href="mailto:sahoosubhankar313@gmail.com" className="text-slate-400 hover:text-rose-400 transition-all hover:scale-110 hover:drop-shadow-[0_0_10px_rgba(244,63,94,0.8)]" title="Email">
          ...
          {isBooting && (
            <div className="w-full max-w-lg text-left mt-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        {/* === RIGHT COLUMN: COMPLETE PHOTO (NO SCANLINE) === */}
